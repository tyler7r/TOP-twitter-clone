...
export const Nav = (props) => {
    ...
    if (isUserSignedIn === true) {
        return (
            <div id='main-nav'>
                <Link to='/profile'><img onClick={() => {setInteraction(true); setProfileView('tweets'); setSearch(''); setSearchMode(false)}} id='profile-icon' src={profilePic()} alt='profilePic' /></Link>
