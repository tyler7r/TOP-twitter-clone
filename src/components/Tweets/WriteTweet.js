...
export const WriteTweet = (props) => {
    const { tweets, uid, username, profilePic, setTweets, setInteraction, setDraftMode, draftMode, checkSignIn, searchMode, currentUser } = props 
...
const TweetDraft = (props) => {
    ...
    return (
        <div id='tweet-draft'>
            <input value={tweet} type='text' name='tweet-text' id='tweet-text' placeholder="What's on your mind? (160 characters)" onChange={(e) => {setTweet(e.target.value)}} maxLength={160} />
