    ...
    if (props.isUserSignedIn === true) {
        return (
            <div id='home-page'>
                ...
                <Feed tweets={props.tweets} setTweets={props.setTweets} interaction={props.interaction} setInteraction={props.setInteraction} profilePic={props.profilePic} username={props.username} />
            </div>
        )
    } else {
        return (
