...
export const Home = (props) => {
    const { setSearch, setSearchMode, setCurrentProfile, setInteraction, signIn, logOut, isUserSignedIn, profilePic, username, uid, checkSignIn, tweets, setTweets, search, currentProfile, currentUser, setProfileView, setHomeView } = props; 
    ...
    return (
        <div id='home-page'>
            ...
            <HomeView setHomeView={setHomeView} checkSignIn={checkSignIn} setInteraction={setInteraction} />
...
const HomeView = (props) => {
    const { setHomeView, checkSignIn, setInteraction } = props;
